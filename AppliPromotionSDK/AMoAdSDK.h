...
#define APSDK_Ad_Key_BadgeWidth        @"APSDKBadgeWidth"
#define APSDK_Ad_Key_BadgeHeight        @"APSDKBadgeHeight"
...
+ (void)sendTriggerID:(NSString *)triggerID
        callbackBlockWithBadge:(void(^)(NSInteger sts, NSString *url, NSInteger width, NSInteger height, NSInteger bdSts, NSString *bdUrl, NSInteger bdWidth, NSInteger bdHeight))callbackBlockWithBadge;
+ (void)sendTriggerID:(NSString *)triggerID
               appKey:(NSString *)appKey
        callbackBlockWithBadge:(void(^)(NSInteger sts, NSString *url, NSInteger width, NSInteger height, NSInteger bdSts, NSString *bdUrl, NSInteger bdWidth, NSInteger bdHeight))callbackBlockWithBadge;
...
#pragma mark nib呼び出し
+(void)showTriggerWithNib:(NSString*)nibfile parentView:(UIView*)parentView;
